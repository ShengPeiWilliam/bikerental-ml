...
Ridge and Lasso regression to evaluate the effect of regularisation.
...
Two (\textit{casual}, \textit{registered}) are excluded from modelling
...
The same $\lambda$ selection procedure is applied, and both regularised
models serve as a comparison against OLS to evaluate whether
penalisation offers any predictive gain under the current feature set.
...
than a stable seasonal or behavioural pattern, and may not generalise
...
regularisation offers limited benefit when the feature set is already
